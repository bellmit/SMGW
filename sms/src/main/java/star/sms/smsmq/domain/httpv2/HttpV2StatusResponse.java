...
public class HttpV2StatusResponse implements Serializable {
	private static final long serialVersionUID = 1L;
    @JacksonXmlElementWrapper(localName = "statusboxlist")
    private List<HttpV2Statusbox> statusboxList;
    @JacksonXmlElementWrapper(localName = "errorstatuslist")
	private List<HttpV2Errorstatus> errorstatusList;

	public List<HttpV2Statusbox> getStatusboxList() {
		return statusboxList;
	}

	public void setStatusboxList(List<HttpV2Statusbox> statusboxList) {
